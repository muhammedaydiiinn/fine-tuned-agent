# CallShield Agent Platform — Gün Gün Tarihli Plan
...
/opt/fine-tuned-agent/repo
/opt/fine-tuned-agent/models
/opt/fine-tuned-agent/data
/opt/fine-tuned-agent/backups
/opt/fine-tuned-agent/logs
```
...
Merged CallShield modelini vLLM ile OpenAI-compatible endpoint olarak çalıştırmak.

### Yapılacaklar

- Model klasörünü `/opt/fine-tuned-agent/models/merged/fine-tuned-agent-v14` altına koyma
- vLLM Docker servisini ayarlama
- model name: `fine-tuned-agent-v14`
...
```text
port: 8000
served_model_name: fine-tuned-agent-v14
max_model_len: 2048
...
- vLLM ile çalışan merged CallShield modeli
- FastAPI agent backend
