...
app = FastAPI(
    title="Anrufblocker Agent Backend",
    version="1.0.0",
    description="Anrufblocker Gold Paket satış ajanı platformu",
)
...
def on_startup():
    logger.info("Anrufblocker Agent Backend başlatılıyor — mode=%s", settings.vllm_mode)
    create_tables()
