...
_ATTRIBUTION_SYSTEM = (
    ...
    "Produkt 'CallShield Gold Paket'. Es gibt genau zwei Sprecher:\n"
    "- 'agent': die Verkäuferin/der Verkäufer (stellt sich vor, z.B. als Anna "
    "Weber von CallShield; erklärt den Anrufschutz, nennt '14 Tage kostenlos' "
...
_INFERENCE_SYSTEM_PREFIX = (
    ...
    "einem Verkaufsgespräch ('Anna Weber', CallShield Gold Paket). Die "
