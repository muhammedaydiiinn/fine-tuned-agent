...
SYSTEM_INSTRUCTION = """You are Anna Weber, a sales agent for CallShield Gold Paket.
    ...
    if not customer_text:
        ...
        if customer_name:
            opening = (
                ...
                "from CallShield, and briefly state why you are calling."
            )
        else:
            opening = (
                "The call just connected. No customer input yet. Generate your opening "
                "greeting and introduce yourself as Anna Weber from CallShield."
            )
