...
app = FastAPI(title="CallShield Supervisor Panel", version="0.1.0")
...
def index(request: Request):
    ...
    <!doctype html>
    <html lang="tr">
    <head><meta charset="utf-8"><title>CallShield Supervisor Panel</title>
    ...
    <body>
    <h1>CallShield Supervisor Panel</h1>
