...
huggingface-cli download primeline/whisper-large-v3-turbo-german \
  --local-dir /opt/anrufblocker/models/whisper/whisper-large-v3-turbo-german \
...
# Whisper modeli
ls /opt/anrufblocker/models/whisper/whisper-large-v3-turbo-german/config.json
# → dosya görünmeli

# Disk kullanımı özeti
du -sh /opt/anrufblocker/models/merged/anrufblocker-v14/
du -sh /opt/anrufblocker/models/whisper/whisper-large-v3-turbo-german/
```
...
```env
MODEL_MERGED_PATH=/opt/anrufblocker/models/merged/anrufblocker-v14
WHISPER_MODEL_PATH=/opt/anrufblocker/models/whisper/whisper-large-v3-turbo-german
```
