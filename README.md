...
|-------|--------|-------------|----------|
| **anrufblocker-v14** | Google Drive (özel) | `models/merged/anrufblocker-v14/` | vLLM — ana satış ajanı |
...
```bash
# GPU sunucuda (varsayılan hedef: /opt/anrufblocker/models)
...
- Drive klasörünü `anrufblocker-v14/` olarak yeniden adlandırır
...
# Tüm klasörü indir
gdown --folder "https://drive.google.com/drive/folders/19eLgqB0W1UUNuFguwTGA6wnLGQmDHj3y" \
      -O /opt/anrufblocker/models/merged/

# Klasör adı farklıysa yeniden adlandır
mv /opt/anrufblocker/models/merged/<drive_klasör_adı> \
...
huggingface-cli download primeline/whisper-large-v3-turbo-german \
  --local-dir /opt/anrufblocker/models/whisper/whisper-large-v3-turbo-german-ct2 \
...
scp -r ./models/merged/anrufblocker-v14/ \
    deploy@SUNUCU_IP:/opt/anrufblocker/models/merged/

# Whisper modelini Mac'ten sunucuya kopyala
scp -r ./models/whisper/whisper-large-v3-turbo-german-ct2/ \
    deploy@SUNUCU_IP:/opt/anrufblocker/models/whisper/
```
...
models/
├── merged/
│   └── anrufblocker-v14/          ← LLM (vLLM'e yüklenir)
│       ├── config.json
│       ├── tokenizer.json
...
```bash
# LLM modeli
ls /opt/anrufblocker/models/merged/anrufblocker-v14/config.json
# → dosya görünmeli

# Whisper modeli
ls /opt/anrufblocker/models/whisper/whisper-large-v3-turbo-german-ct2/model.bin
# → dosya görünmeli

# Disk kullanımı özeti
du -sh /opt/anrufblocker/models/merged/anrufblocker-v14/
du -sh /opt/anrufblocker/models/whisper/whisper-large-v3-turbo-german-ct2/
```
...
```env
MODEL_MERGED_PATH=/opt/anrufblocker/models/merged/anrufblocker-v14
WHISPER_MODEL_PATH=/opt/anrufblocker/models/whisper/whisper-large-v3-turbo-german-ct2
```
...
| `MODEL_MERGED_PATH` | LLM model klasörü — `models/merged/anrufblocker-v14` | ✅ |
