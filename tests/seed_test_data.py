...
DB = dict(
    ...
    dbname=os.getenv("POSTGRES_DB", "fine_tuned_agent"),
    user=os.getenv("POSTGRES_USER", "fine_tuned_agent"),
...
MODEL_VERSIONS = ["fine-tuned-agent-v12", "fine-tuned-agent-v13", "fine-tuned-agent-v14"]
    ...
    for name in MODEL_VERSIONS:
        cur.execute(
            ...
            (
                ...
                "active" if name == "fine-tuned-agent-v14" else random.choice(["inactive", "inactive", "deprecated"]),
